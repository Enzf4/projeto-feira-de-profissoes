$("#searchBtn").click(function () {
  ...
  const queryCensurada = palavroes.some((palavrao) =>
    query.includes(palavrao.toLowerCase())
  );
  ...
  $.getJSON(
    "https://api.themoviedb.org/3/search/movie?api_key=3349c6aa066a33c14a64384200f8c190&query=" +
      query +
    ...
    function (data) {
      ...
      $.getJSON(
        "https://api.themoviedb.org/3/search/movie?api_key=3349c6aa066a33c14a64384200f8c190&query=A Rede Social&include_adult=false&language=en-US&page=1",
        function (data2) {
          $("#poster2").attr(
            "src",
            "https://image.tmdb.org/t/p/w500" + data2.results[0].poster_path
          );
        }
      );
    }
...
const continuar = document.getElementById("completou");
